...
const stores: OpticalStore[] = [
  ...
  { id: 3, name: "Bustamante", address: "Orotina centro frente al Banco Nacional", region: "Ruta Larga C1", whatsapp: "63205870", phone: "24289428" },
  { id: 4, name: "La Óptica", address: "Atenas centro, Plaza la fuente local #02", region: "Ruta Larga C1", whatsapp: "72708090", phone: "88440863" },
  { id: 5, name: "Rosa Murillo", address: "Alajuela. Atenas, centro comercial plaza central 150m este del Banco de CR", region: "Ruta Larga C1", whatsapp: "88820285", phone: "24464581", email: "info@opticacv.com" },
  ...
  { id: 18, name: "Rodolfo Alfaro", address: "Grecia, santa gertrudis norte", region: "Ruta Larga C1", whatsapp: "70290504", phone: "24443476" },
  ...
  { id: 20, name: "Audivisión", address: "Alajuela Naranjo, costado del", region: "Ruta Larga C1", whatsapp: "84864141", phone: "24514141" },
  { id: 21, name: "San Judas Tadeo", address: "Alajuela Naranjo 100 mtrs al oeste del mercado municipal de Naranjo", region: "Ruta Larga C1", whatsapp: "88694444", phone: "24511898" },
  { id: 22, name: "Sancho Palmares", address: "Palmares centro frente a tienda Vargas", region: "Ruta Larga C1", whatsapp: "22602007", phone: "24530939" },
  { id: 23, name: "Rosán", address: "Al costado norte del banco nacional, Alajuela", region: "Ruta Larga C1", phone: "24457295" },
  { id: 24, name: "Nueva Imagen", address: "100 METROS SUR DEL HOSPITAL DE SAN RAMON, mano izquierda edificio esquinero", region: "Ruta Larga C1", phone: "24456507" },
  ...
  { id: 26, name: "El Pueblo", address: "DENTRO DE FARMACIA EL PUEBLO SAN RAMON", region: "Ruta Larga C1", whatsapp: "24476161", phone: "24476161" },
  { id: 27, name: "Edificio Rosán", address: "Al costado sur del parque, 75m oeste de la parroquia de san ramón", region: "Ruta Larga C1", phone: "24453152" },
  ...
  { id: 31, name: "Mynor Torres", address: "Grecia Centro, del Liceo Deportivo de Grecia 25m al oeste", region: "Ruta Larga C1", whatsapp: "89856036" },
  { id: 32, name: "Panorama", address: "Clínica médica Sanchez en Grecia", region: "Ruta Larga C1", whatsapp: "88119142", phone: "72150203", email: "panorama.clinicavisual@gmail.com" },
  ...
  { id: 42, name: "BERMÚDEZ", address: "100M NORTE DE TACO BELL", region: "Heredia", whatsapp: "85710961", email: "info@opticasbermudez.com" },
  ...
  { id: 45, name: "AUGEN (ROSO)", address: "Santo Domingo de Heredia, 200 este del MasxMenos contiguo a pintura sur", region: "Heredia", whatsapp: "87355917", email: "opticaaugen@hotmail.com" },
  ...
  { id: 47, name: "SARA MENA", address: "San Rafael de Heredia, 200 este, 75 norte de la fuerza publica. Plaza cristina 2do piso", region: "Heredia", whatsapp: "72835714", email: "consultorioopticosm@gmail.com" },
  { id: 48, name: "LUNETTE", address: "San Rafael, CC el Campanario, contiguo a la municipalidad de San rafael de heredia", region: "Heredia", whatsapp: "64273232", email: "opticalunettecr@gmail.com" },
  { id: 49, name: "BUENA VISTA (BARVA)", address: "100 OESTE Y 25 SUR DEL BANCO DE COSTA RICA DE BARBA DE HEREDIA", region: "Heredia", whatsapp: "89080406", email: "Jusamainversiones@gmail.com" },
  ...
  { id: 60, name: "BARTOLONE", address: "Barva, 75 norte del BCR", region: "Heredia", whatsapp: "89466244", email: "romespinozalvarez@gmail.com" },
  ...
  // PERIFÉRICA
  { id: 67, name: "SIMAN", address: "San José", region: "Periférica" },
  ...
  { id: 71, name: "BARRANTES", address: "CORONADO CENTRO 200 sur de la cruz Roja", region: "Periférica", whatsapp: "70268588" },
  { id: 72, name: "CSG", address: "Multiplaza del este, 175 al noroeste, mano derecha, casa porton blanco", region: "Periférica", whatsapp: "88321137" },
  ...
  { id: 81, name: "NOVA SAN PEDRO", address: "San Pedro Montes de Oca, edificio Bisnes Center, diagonal al parque de San Pedro", region: "Periférica", whatsapp: "60062676" },
  ...
  { id: 107, name: "ÁLVAREZ Y MOLINA", address: "25m norte del banco de cr san pedro de poas", region: "Alajuela", whatsapp: "24406905" },
  ...
  { id: 126, name: "Sime", address: "Diagonal a plaza Roohmoser dentro de Clínica Salud sin Frontera Pavas", region: "Occidente", whatsapp: "87463686", email: "marileo09@hotmail.com" },
  ...
  { id: 188, name: "Hospital", address: "Frente a la farmacia del Hospital Max Peralta", region: "Cartago" },
  { id: 189, name: "Troyo", address: "75 METROS SUR DE LA ESCUELA JESUS JIMENEZ CARTAGO CENTRO", region: "Cartago" },
  ...
  { id: 191, name: "Santa Lucía", address: "375 METROS OESTE DEL MERCADO CENTRAL DE CARTAGO CENTRO av1 entre calle 10 y 12", region: "Cartago" },
  { id: 192, name: "Grisol", address: "BARRIO EL MOLINO 200 METROS ESTE DE METRO CENTRO FRENTE A FERRETERIA EL POCHOTE CARTAGO CENTRO", region: "Cartago" },
  { id: 193, name: "Vives Molino", address: "125 METROS OESTE de La iglesia Maria auxiliadora de Cartago", region: "Cartago" },
  { id: 194, name: "Jade", address: "100 METROS SUR DE RENO CITY TEJAR CARTAGO", region: "Cartago" },
  ...
  { id: 226, name: "La Isla", address: "Limón centro del supermercado MXM 250 metros al norte edificio blanco con azul, dentro de la clínica Santa Tereza", region: "Encomiendas", whatsapp: "87153881" },
  ...
  { id: 231, name: "A su Alcance", address: "Terminal de caribeños, limon centro local 3", region: "Encomiendas" },
  ...
  { id: 238, name: "Oxo", address: "Calle el desvío, 100 norte de Maxi Pali, carretera principal", region: "Encomiendas", whatsapp: "83060808" },
  { id: 239, name: "D´Arce", address: "25m NORTE DE LA ESCUELA JUAN CHAVES", region: "Encomiendas", whatsapp: "83175961" },
  { id: 240, name: "Zarcero", address: "25 METROS SUR DEL BANCO NACIONAL DE ZARCERO", region: "Encomiendas", whatsapp: "89630178" },
  ...
  { id: 243, name: "Elizondo", address: "PEREZ ZELEDON, SAN ISIDRO FRENTE AL PARQUE CENTRAL A UN COSTADO DEL BAR Y RESTAURANTE LA REINA DEL VALLE", region: "Encomiendas", whatsapp: "89194856" },
  { id: 244, name: "Karen Padilla", address: "PEREZ ZELEDON", region: "Encomiendas" },
  { id: 245, name: "Gmo", address: "San Isidro Perez Zeledon por encomienda", region: "Encomiendas", whatsapp: "70119777" },
  ...
  { id: 251, name: "San Juan Upala", address: "UPALA, 100m oeste de las oficinas el INDER", region: "Encomiendas", whatsapp: "85644396" },
  ...
  { id: 254, name: "Padilla", address: "175 METROS ESTE DE COOPEALIANZA, NICOYA", region: "Encomiendas", whatsapp: "88205781" },
  { id: 255, name: "Pacífico (Tamarindo)", address: "TAMARINDO, Santa Cruz Tempate cruce de guacas centro comercial las americas local 5y6", region: "Encomiendas", whatsapp: "87226790" },
