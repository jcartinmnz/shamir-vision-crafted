    ...
    <section className="py-16 lg:py-20 bg-dark-surface text-dark-surface-foreground">
      <div ref={ref} className="container mx-auto px-4 lg:px-8">
        <div className="grid md:grid-cols-2 gap-12 max-w-4xl mx-auto">
          <div className={`text-center animate-scale-in ${isVisible ? "is-visible" : ""}`}>
          ...
          <div className={`text-center animate-scale-in ${isVisible ? "is-visible" : ""}`} style={{ transitionDelay: "150ms" }}>
